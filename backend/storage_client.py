...
class GoStorageClient:
    ...
    def __init__(self, base_url: str = None):
        self.base_url = base_url or os.getenv("GO_STORAGE_URL", "http://localhost:8081")

    def save_message(self, message_id: str, chat_id: str, sender_id: str, ciphertext: str, nonce: str = "", auth_tag: str = "") -> dict:
...
storage_client = GoStorageClient()
